...
@compile_mode("script")
class MACE_with_charge(torch.nn.Module):
    def __init__(
        self,
        r_max: float,
        num_bessel: int,
        ...
        charge_embedding_dim: Optional[int] = 1,
    ):
        super().__init__()
        ...
        self.charge_projection = torch.nn.Linear(1, charge_embedding_dim)
    ...
    def forward(
        ...
        print('lenth of node feature list',len(node_feats_list))
